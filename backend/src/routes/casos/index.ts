...
router.get("/busca-rapida", CasosCrontroller.getFast);
...
router.get("/:id", checkCaseAccess('params', 'id'), CasosCrontroller.getCaso); //lista 1 caso por id
router.get("/:casoId/encaminhamentos", checkCaseAccess('params', 'casoId'), CasosCrontroller.getEncaminhamentos); // lista os encaminhamentos de um caso especifico
